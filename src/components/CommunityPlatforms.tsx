const platforms = [
  {
    name: "Discord",
    desc: "Chat en vivo, canales de voz y ayuda técnica.",
    href: "#",
  ...
  {
    name: "WhatsApp",
    desc: "Grupos por temática y anuncios rápidos.",
  ...
  {
    name: "LinkedIn",
    desc: "Networking profesional y oportunidades.",
    href: "#",
    iconBg: "bg-blue-100",
  ...
  {
    name: "GitHub",
    desc: "Proyectos open source de la comunidad.",
    href: "#",
    iconBg: "bg-slate-100",
  ...
  {
    name: "X (Twitter)",
    desc: "Noticias y novedades de la comunidad.",
    href: "#",
    iconBg: "bg-slate-900",
  ...
  {
    name: "Instagram",
    desc: "Fotos, eventos y momentos de la comunidad.",
    href: "#",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 text-lg max-w-xl mx-auto">
            Nuestra comunidad vive en diferentes plataformas. Elegí la tuya y empezá a interactuar.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {platforms.map((p) => (
            <a
              ...
              className={`group bg-white rounded-2xl p-6 flex items-start gap-4 border border-slate-100 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg ${p.hoverBorder}`}
            >
              <div className={`w-14 h-14 rounded-2xl ${p.iconBg} flex items-center justify-center flex-shrink-0`}>
                {p.icon}
              </div>
              <div>
                <h3 className="font-display font-bold text-lg text-slate-800 mb-1">{p.name}</h3>
