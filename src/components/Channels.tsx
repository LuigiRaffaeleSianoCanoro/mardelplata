...
export default function Channels() {
  return (
    <section className="channels-x shell-section shell-section--soft" aria-labelledby="channels-heading">
      <div className="shell-inner">
        <header className="channels-x-head">
          <p className="shell-eyebrow">SUMATE A LA CONVERSACIÓN</p>
          <h2 id="channels-heading" className="shell-title">
            Donde late la <em>comunidad.</em>
          </h2>
        </header>
