                  ...
                  {isEditing ? (
                    ...
                    <>
                      <div>
                        ...
                        <p className="text-ocean-300 text-sm">{profile?.email}</p>
                      </div>
                      {profile?.bio && (
                        <p className="text-ocean-200">{profile.bio}</p>
                      )}
                      <div className="flex gap-3">
                        {profile?.github_url && (
                          <a href={profile.github_url} target="_blank" rel="noopener noreferrer" className="text-ocean-400 hover:text-white transition-colors">
                        ...
                        {profile?.linkedin_url && (
                          <a href={profile.linkedin_url} target="_blank" rel="noopener noreferrer" className="text-ocean-400 hover:text-white transition-colors">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        {profile?.twitter_url && (
                          <a href={profile.twitter_url} target="_blank" rel="noopener noreferrer" className="text-ocean-400 hover:text-white transition-colors">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            <div className="bg-ocean-800/50 backdrop-blur-xl rounded-3xl p-6 border border-ocean-600/30 shadow-2xl">
              ...
              <div className="mt-4 bg-ocean-900/50 rounded-xl p-3 text-center">
                <span className="text-ocean-400 font-mono text-sm">{profile?.qr_code}</span>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-white font-medium">
                    {profile?.created_at ? new Date(profile.created_at).toLocaleDateString("es-AR", { month: "short", year: "numeric" }) : "-"}
                  </span>
                </div>
                <div className="flex justify-between items-center">
