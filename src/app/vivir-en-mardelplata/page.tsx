...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/vivir-en-mardelplata",
    languages: {
  ...
  openGraph: {
    ...
    type: "website",
    images: [ogImageUrl("Vivir en Mar del Plata", "Remoto, con vista al mar")],
  },
};
        ...
        <header className="shell-section shell-section--lg">
          <div className="shell-inner shell-inner--narrow" style={{ textAlign: "center" }}>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "1rem" }}>
              <LangSwitcher es="/vivir-en-mardelplata" en="/en/live-in-mar-del-plata" current="es" />
            </div>
